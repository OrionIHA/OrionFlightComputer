...
* R1=560K, R2=100K... 21.78V max input = 3.3V out, ...12.6V in = 1.9090...V out
* Warning: LightFlight v1.0 can support 2-16V battery voltage
* Note: Wise to add 10uF capacitor across R2 but not vital. You may need to increase weighted filter values if not fitted.
* There is no capacitor at this circuit
* 
*                        ______ Vin... +ve of flight battery. 5s Lipo max or you will damage the ESP32!
*                      _|_
*                     |   |
*                     |   |  R1 = 560K Ohms
*                     |___|
