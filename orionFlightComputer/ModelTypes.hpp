...
public:
  ...
  /**
    ...
    */
  int32_t getTrimMultiplier() const {
    return servo[0].getTrimMultiplier();
  }
...
public:
  static constexpr uint8_t NUMBER_MOTORS = 2;
  static constexpr uint8_t NUMBER_SERVOS = 4;
  static constexpr uint8_t SERVO_1_PIN = 15;
  static constexpr uint8_t SERVO_2_PIN = 47;
  static constexpr uint8_t SERVO_3_PIN = 33;
  static constexpr uint8_t SERVO_4_PIN = 48;
  static constexpr uint8_t MOTOR_1_PIN = 46;
  static constexpr uint8_t MOTOR_2_PIN = 45;
