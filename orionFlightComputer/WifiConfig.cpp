...
*/
void WifiConfig::doWiFiStateMachine() {
  switch (m_state) {
    case WifiState::OFF:
...
*/
bool WifiConfig::startWifiConfigurator() {
...
*/
void WifiConfig::stopWifiConfigurator() {
  client.stop();
...
*/
void WifiConfig::serviceWifiConfigurator()  //FileSystem::NonVolatileData * const fileData)
{
  if (!client) {
...
*/
void WifiConfig::removeHeadTail(StringHandler* const str, uint32_t headerLength) {
  int32_t idx;
...
*/
void WifiConfig::sendHtml(WiFiClient* const theClient) {
...
*/
bool WifiConfig::updatePidf(StringHandler* const str, PIDF::Gains* const theGains) {
  bool updated = false;
...
* @return true when a value has been updated.
*/
bool WifiConfig::updateRates(StringHandler* const str) {
  bool updated = true;
...
* @return true when a value has been updated.
*/
bool WifiConfig::updateLevelTrims(StringHandler* const str) {
  bool updated = false;
...
* @return true when a value has been updated.
*/
bool WifiConfig::updateMaxAngles(StringHandler* const str) {
  bool updated = false;
...
* @return true when a value has been updated.
*/
bool WifiConfig::updateServoTrims(StringHandler* const str) {
  bool updated = false;
...
* @return true when a value has been updated.
*/
bool WifiConfig::updateBatteryTrims(StringHandler* const str)  //, float* const batteryTrim)
{
  bool updated = false;
...
* @return true when a value has been updated.
*/
bool WifiConfig::hasUpdatedData() {
