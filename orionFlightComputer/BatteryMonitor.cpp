...
*/
void BatteryMonitor::begin(const float batteryScaler) {
...
*/
void BatteryMonitor::setNumberCells() {
...
*/
void BatteryMonitor::setVoltageScaler(const float newVoltageScaler) {
