...
*/
void FileSystem::stringToCharArray(const String* const str, char* const charBuff) {
...
*/
bool FileSystem::readDataFromFile(String* const fileData) {
...
*/
bool FileSystem::writeDataToFile(String const* const fileData) {
